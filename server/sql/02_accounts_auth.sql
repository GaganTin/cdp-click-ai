...
VALUES
  ('free', 'Free', '$0', '1 month free', 'Trial',
   ...
   '["Solo user only (no team members)","1 workspace","1,000 customer profiles","5 email campaigns","1,000 AI tokens","UTM tracking"]'::jsonb,
   '{"profiles":1000,"campaigns":5,"ai_tokens":1000,"team_members":1,"workspaces":1}'::jsonb),
