...
export const appClient = {
  ...
  attributes: {
    ...
    retagPages: (page_ids, attribute_ids) => request("/attributes/web-pages/retag", { method: "POST", body: JSON.stringify({ page_ids, attribute_ids }) }),
    keepPages: (page_ids) => request("/attributes/web-pages/keep", { method: "POST", body: JSON.stringify({ page_ids }) }),
