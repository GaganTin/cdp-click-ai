...
export default function ImpersonationBanner() {
  ...
  return (
    <div className="flex items-center justify-between gap-3 px-4 py-2.5 bg-amber-500/15 border-b border-amber-500/30 text-sm">
      ...
      <button
        onClick={logout}
        className="flex-shrink-0 inline-flex items-center gap-1.5 px-3 py-1 bg-amber-600 text-white text-xs font-semibold rounded-md hover:bg-amber-700 transition-colors"
      >
